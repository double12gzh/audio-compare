                ...
                try:
                    ...
                    if y1 is not None and y2 is not None:
                        ...
                        with tab_wave:
                            ...
                            waveform_comp_fig = (
                                self.visualizer.plot_comparison_waveform(
                                    y1,
                                    y2,
                                    sr1,
                                    title1=f"音频1 ({audio1_name})",
                        ...
                        with tab_mel_centroid:
                            overlay_centroid_fig = (
                                self.visualizer.plot_overlay_mel_spectral_centroid(
                                    y1,
                                    y2,
                                    sr1,
                                    title1=f"音频1 ({audio1_name})",
                            ...
                            ChartDisplay.render_chart(
                                overlay_centroid_fig, "叠加 Mel 谱率对比"
                            )

                            mel_centroid_fig = (
                                self.visualizer.plot_comparison_mel_spectral_centroid(
                                    y1,
                                    y2,
                                    sr1,
                                    title1=f"音频1 ({audio1_name})",
                    ...
                    with st.expander(title, expanded=False):
                        try:
                            ...
                            if y1 is not None and y2 is not None:
                                ...
                                if use_multi_scale:
                                    st.info(
                                        f"检测到不同采样率: 音频A ({sr1} Hz) vs 音频B ({sr2} Hz)"
                                    )
                                    ...
                                    if comparison_mode == "多尺度对比":
                                        multi_scale_results = self.analyzer.calculate_multi_scale_similarity(
                                            y1, y2, sr1, sr2
                                        )
                                ...
                                with tab_wave:
                                    overlay_wave_fig = (
                                        self.visualizer.plot_overlay_waveform(
                                            y1,
                                            y2,
                                            sr1,
                                            title1=f"音频A ({fname})",
                                ...
                                with tab_mel_centroid:
                                    ...
                                    ChartDisplay.render_chart(
                                        mel_centroid_fig, "Mel 谱率对比"
                                    )

                                with tab_mfcc:
                                    mfcc_comp_fig = (
                                        self.visualizer.plot_comparison_mfcc(
                                            y1,
                                            y2,
                                            sr1,
                                            title1=f"音频A ({fname})",
